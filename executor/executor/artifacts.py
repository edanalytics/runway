...
IDRS_MATCHES = JobArtifact(
    "idrs_matches",
    os.path.join(config.OUTPUT_DIR, "idrs_matches.json"),
    False
)

ALL = [ROSTER, CROSS_YEAR_ROSTER, EM_RESULTS, EM_RESULTS_X_YEAR, MATCH_RATES, UNMATCHED_STUDENTS, LB_SEND_RESULTS, CANDIDATES, IDRS_MATCHES]